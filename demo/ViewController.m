...
- (IBAction)didPressedClick:(id)sender {
...

    {
        ...
        [LYWindowScreenView addWindowScreenView:_label1 page:self.class level:LYLevelHigh keepAlive:NO addCompleted:nil];
    }
    ...
    
    {
        ...
        [LYWindowScreenView addWindowScreenView:self.label3 page:self.class level:LYLevelDefault keepAlive:YES addCompleted:nil];
    }
}
...
- (IBAction)activity:(id)sender {
    [LYWindowScreenView addWindowScreenView:self.activityView page:self.class level:LYLevelDefault keepAlive:YES addCompleted:nil];
}
