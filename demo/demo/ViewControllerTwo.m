...
//  demo
//
//  Created by langezhao on 2019/12/24.
...
- (void)viewDidLoad {
    ...
    [LYWindowScreenView addWindowScreenView:self.label3 pages:@[self.class] level:LYLevelDefault keepAlive:YES controller:nil showCompleted:^{
        NSLog(@"444");
    }];
}
